...
public class Leg {
    ...
    public Leg(Stop start, Stop end) {
        ...
        this.minSpeed = randomizer.nextDouble()*2+2; //min speed would be between 5(inclus) meters and 10(exclus)
        this.maxSpeed = randomizer.nextDouble()*2+4; //max speed would be 25 meters per second
    }
